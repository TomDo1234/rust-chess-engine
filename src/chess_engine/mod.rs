...
pub fn calculate_position(board: &[Option<Piece> ; 64],whos_move: Color,recursion_level: u8,current_recursion: u8,
                        value: i32,mut alpha: i32,mut beta: i32,zobrist_hasher: &ZobristHash,transposition_table: &HashMap<u64,i32>) -> (Option<PieceType>,i8,i32) {
                ...
                for movement in moves {
                    ...
                    if recursion_level != current_recursion {
                        let foresight_value = calculate_position(&new_board, if whos_move == Color::White { Color::Black } else { Color::White },
                                                    recursion_level, current_recursion + 1,value + take_value,alpha,beta,zobrist_hasher,&transposition_table).2;
...
mod tests {
    ...
    fn test_simple_take() {
        ...
        let (best_move_piece_1,best_move_1,max_1) = calculate_position(&board,color_to_play,4,1,0,0,0,&ZobristHash::new(),&transposition_table);
    ...
    fn test_scholar() {
        ...
        let (best_move_piece_1,best_move_1,max_1) = calculate_position(&board,color_to_play,4,1,0,999,-999,&ZobristHash::new(),&transposition_table);
    ...
    fn test_back_rank() {
        ...
        let (best_move_piece_1,best_move_1,max_1) = calculate_position(&board,color_to_play,3,1,0,999,-999,&ZobristHash::new(),&transposition_table);
    ...
    fn test_two_move() {
        ...
        let (best_move_piece_1,best_move_1,max_1) = calculate_position(&board,color_to_play,5,1,0,999,-999,&ZobristHash::new(),&transposition_table);
